...
export default function Account() {
  ...
  // Build analytics data for chart
  const chartData = (() => {
    const counts = {};
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="bg-gray-800 p-4 rounded mb-4">
        <p><strong>User:</strong> {user?.fullName || user?.username || user?.emailAddresses?.[0]?.emailAddress}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-gray-800 p-4 rounded">
          ...
          <div className="mt-3 flex gap-2">
            ...
            <button
              onClick={() => alert("MAL Sync needs backend. I can add it anytime.")}
          ...
          {data.entries.map((item) => (
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => {
                    const updated = data.entries.filter(
                      (e) => e.id !== item.id
                    );
